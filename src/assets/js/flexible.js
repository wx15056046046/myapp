...
!(function (a, b) {
  ...
  if (g) {
    ...
    if (m) {
      ...
      n &&
        ((i = parseFloat (n[1])), (j = parseFloat ((1 / i).toFixed (2)))), o &&
        ((i = parseFloat (o[1])), (j = parseFloat ((1 / i).toFixed (2))));
    }
  }
  if (!i && !j) {
    var p = (a.navigator.appVersion.match (
      /android/gi
  ...
  if ((f.setAttribute ('data-dpr', i), !g))
    if (
      ((g = e.createElement ('meta')), g.setAttribute (
        'name',
        'viewport'
      ), g.setAttribute (
        'content',
  ...
  a.addEventListener (
    ...
    : e.addEventListener (
        ...
        !1
      ), c (), (k.dpr = a.dpr = i), (k.refreshRem = c), (k.rem2px = function (
    a
  ) {
